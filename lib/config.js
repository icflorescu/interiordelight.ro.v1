module.exports = {
	...
	passport: {
		realm: process.env.APP_URL || 'http://interiordelight.herokuapp.com',
		returnURL: (process.env.APP_URL || 'http://interiordelight.herokuapp.com') + '/login/return',
		admins: [
			'ionut.florescu@gmail.com',
			'irinel.florescu@gmail.com',
			'adrian.ene@gmail.com'
		]
	},
